...
//print("The value of foo is \(foo)")
// it will cause a compiler error because foo is declared inside the for loop block. Its scope is within the loop, so it cannot be accessed outside of it.
...
//This code will compile because x is declared outside the for loop, in the global scope. It is accessible both inside and outside the loop.
...
greeting(greeting: "Hi there", name: "Sanna")
greeting(greeting: nil, name: "Ali")
